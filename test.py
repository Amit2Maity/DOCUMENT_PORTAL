...
def test_compare_docuemnts():
    ref_path = Path("D:\\DataScience\\LLMOPS\\DOCUMENT_PORTAL\\data\\document_compare\\Long_Report_V1.pdf")
    act_path = Path("D:\\DataScience\\LLMOPS\\DOCUMENT_PORTAL\\data\\document_compare\\Long_Report_V2.pdf")
    ...
    comparison_df.to_csv("D:\\DataScience\\LLMOPS\\DOCUMENT_PORTAL\\data\\output\\comparison_result.csv", index=False)
